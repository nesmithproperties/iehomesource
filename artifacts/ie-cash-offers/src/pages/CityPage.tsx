...
const cityData: Record<string, CityPageProps> = {
  riverside: {
    ...
    description:
      "Riverside is the largest city in the Inland Empire and home to a diverse range of neighborhoods. Whether you're in Canyon Crest, Wood Streets, or near UCR, we buy houses throughout Riverside quickly and for a fair cash price.",
    highlights: [
  ...
  "san-bernardino": {
    ...
    description:
      "San Bernardino homeowners face unique challenges—whether it's an aging property, financial pressure, or a life transition. We buy houses throughout San Bernardino in any condition, with no fees or commissions.",
    highlights: [
  ...
  fontana: {
    ...
    county: "San Bernardino County",
    description:
      "Fontana is a fast-growing city with a strong community feel. If you need to sell your Fontana home fast—whether due to relocation, financial hardship, or inherited property—we can help with a direct cash offer.",
    highlights: [
  ...
  "moreno-valley": {
    ...
    county: "Riverside County",
    description:
      "Moreno Valley homeowners can skip the stress of listing. We purchase homes throughout MoVal quickly and fairly—no open houses, no repairs, no waiting months for a buyer.",
    highlights: [
  ...
  "rancho-cucamonga": {
    ...
    county: "San Bernardino County",
    description:
      "Rancho Cucamonga has some of the most desirable properties in the Inland Empire. If you need a quick, hassle-free sale, we make competitive cash offers on homes throughout RC—from Victoria Gardens to Etiwanda.",
    highlights: [
  ...
  ontario: {
    ...
    county: "San Bernardino County",
    description:
      "Ontario's central location makes it a hub for the Inland Empire. If you're looking to sell your Ontario home without the traditional hassle, we provide direct cash purchases with a smooth, transparent process.",
    highlights: [
  ...
  corona: {
    ...
    county: "Riverside County",
    description:
      "Corona is a thriving city with a growing real estate market. Whether you're dealing with a difficult tenant, facing foreclosure, or simply need to sell fast, we buy houses throughout Corona quickly and fairly.",
    highlights: [
  ...
  victorville: {
    ...
    county: "San Bernardino County",
    description:
      "Victorville homeowners in the High Desert can count on us for a fast, direct sale. We understand the High Desert market and can make fair cash offers on homes throughout Victorville regardless of condition.",
    highlights: [
  ...
  murrieta: {
    ...
    county: "Riverside County",
    description:
      "Murrieta is one of the fastest-growing cities in Southern California. If you need to sell your Murrieta home without the stress of a traditional listing, we offer a fast, honest, and straightforward cash buying process.",
    highlights: [
  ...
  temecula: {
    ...
    county: "Riverside County",
    description:
      "Temecula's wine country charm attracts buyers from across SoCal. But if you need to sell quickly, the traditional market can be slow. We buy Temecula homes directly for cash—no waiting, no hassle.",
    highlights: [
  ...
  rialto: {
    ...
    county: "San Bernardino County",
    description:
      "Rialto homeowners who need a quick, straightforward sale can rely on us. We buy homes throughout Rialto in any condition and situation—no fees, no repairs, no waiting.",
    highlights: [
  ...
  hesperia: {
    ...
    county: "San Bernardino County",
    description:
      "Hesperia is a growing High Desert community with a wide range of properties. We buy houses throughout Hesperia quickly and fairly—whether you're behind on payments, need to relocate, or just want a fast, clean sale.",
    highlights: [
...
export default function CityPage({ citySlug }: { citySlug: string }) {
  ...
  const { city, county, description, highlights } = data;
              ...
              <div className="bg-white rounded-xl shadow-2xl overflow-hidden border-t-8 border-primary w-full max-w-[520px]">
                <div className="w-full h-[480px] p-4 bg-white flex items-center justify-center">
                  <iframe
                    ...
                    data-height="344"
                    data-layout-iframe-id={`inline-city-${citySlug}`}
