...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      {/* ── EXPERT HOME BUYERS + TRUST SECTION ── */}
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-serif font-black mb-6 tracking-tighter text-slate-900 uppercase">
            Expert Cash Home Buyers in <span className="text-[#0891b2]">the Inland Empire & Southern California</span>
          </h2>
          <p className="text-lg text-slate-600 leading-relaxed font-medium mb-4 max-w-3xl mx-auto">
            ...
            San Bernardino to the High Desert and the surrounding communities. But our reach extends across California, helping
            homeowners throughout the state who need a fast, fair, and hassle-free way to sell.
          </p>
          <p className="text-lg text-slate-600 leading-relaxed font-medium mb-10 max-w-3xl mx-auto">
            ...
            locally owned, family-operated company. We buy houses as-is throughout Southern California — no repairs, no commissions,
            no call centers. Just a straightforward cash offer and a closing date that works for you, in as little as 7 days.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-left mb-16">
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
              ...
              <p className="text-slate-600 text-sm font-medium leading-relaxed">Our offers are based on real local Inland Empire market data — not lowball algorithms. You'll always receive a fair and competitive price.</p>
            </div>
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
              ...
              <p className="text-slate-600 text-sm font-medium leading-relaxed">We're not a national hedge fund. We're a local Inland Empire team that actually lives and works in the communities we serve across Southern California.</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {[
                ...
                },
                {
                  ...
                  text: "No call centers. No middlemen. No runaround. When you reach out to us, you speak directly with the person making the offer — someone who knows your neighborhood and genuinely wants to help.",
                },
                {
                  icon: ShieldCheck,
                ...
                },
                {
                  ...
                  text: "Sell your home exactly as it sits today. Leave behind what you don't want. We handle the cleanup, the repairs, and everything else after closing — so you don't have to lift a finger.",
                },
              ].map((item, i) => (
